...
module.exports = {
  config: {
    ...
    author: "Tanvir",
    shortDescription: {
      bn: "অটো নামাজ রিমাইন্ডার + প্রতি ঘন্টায় ইসলামিক বার্তা পাঠায়"
    },
    longDescription: {
      bn: "বাংলাদেশ সময় অনুযায়ী নামাজের সময় মনে করিয়ে দেয় এবং প্রতি ঘন্টায় ইসলামিক দোয়া বা হাদিস পাঠায়"
    },
    category: "islamic",
  },
  ...
  onStart: async function ({ api }) {
    ...
    }, 60 * 60 * 1000); // প্রতি ঘন্টায় পাঠাবে

    // 🕌 নামাজ রিমাইন্ডার সময়সূচি (বাংলাদেশ সময়)
    const prayerTimes = {
      Fajr: "04:45",
      Dhuhr: "12:05",
      Asr: "15:30",
